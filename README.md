...
Укажите у контрола Wiren Board тип `gas` или `water`: существующий маппинг
интеграции назначит соответствующий класс Home Assistant и включит долговременную
статистику накопительного счётчика.
