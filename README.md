...
- распознаёт счётчики газа и воды с единицей `m³` и позволяет выбрать их тип;
...
В меню `Настроить счётчики газа и воды` можно указать назначение каждого такого
сенсора. Интеграция установит соответствующий класс устройства Home Assistant и
включит долговременную статистику накопительного счётчика.
...
в списках инверсии бинарных сенсоров и настройки счётчиков.
